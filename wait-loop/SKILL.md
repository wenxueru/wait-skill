...
2. Execute the saved task once, using reasonable defaults for reversible choices within the task and existing authorization. The root session performs each iteration; do not create an autonomous child loop.
